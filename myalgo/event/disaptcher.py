...
class Dispatcher(object):
    ...
    def addSubject(self, subject):
        ...
        if subject.dispatch_priority is dispatchprio.LAST:
        ...
        subject.on_dispatch_priority_registered(self)
    ...
    def __dispatchSubject(self, subject, currEventDateTime):
        ...
        if not subject.eof() and subject.peek_datetime() in (None, currEventDateTime):
    ...
    def __dispatch(self):
        ...
        for subject in self.__subjects:
            if not subject.eof():
                eof = False
                smallestDateTime = utils.safe_min(smallestDateTime, subject.peek_datetime())
